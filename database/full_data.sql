-- Full MySQL schema + seed for QLBanMayAnh (ASCII content)
...
('admin@camera.shop', '$2y$10$T/.8h/y3bTLwFsJcyzIs3e6iQn0L.H1bonPuSKrl1yus.u9iFjO7e', 0),
('user@test.com', '$2y$10$T/.8h/y3bTLwFsJcyzIs3e6iQn0L.H1bonPuSKrl1yus.u9iFjO7e', 1);
...
('user@test.com', 'user@test.com', 'User Test', '0900000000', 'Ha Noi', 'Tai khoan test');
